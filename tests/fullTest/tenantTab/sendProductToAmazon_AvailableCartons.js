...
export function SendProductToAmazon_AvailableCartons() {
    const url = 'https://test.dev.skudrop.com/login';

    const email = 'admin@example.com';
    const password = 'admin';

    const numberOfCartons = "5";
    ...
    page.goto(url, { waitUntil: 'networkidle' })
        .then(() => {
            group('SendProductToAmazon_AvailableCartons: Visit login page and authorization', function () {
        ...
        .then(() => {
            group('SendProductToAmazon_AvailableCartons: Waiting for Dashboard page and go to Send Product To Amazon page', function () {
        ...
        .then(() => {
            group('SendProductToAmazon_AvailableCartons: Fill in number of cartons and click Create Shipping Plan button', function () {
        ...
        .then(() => {
            group('SendProductToAmazon_AvailableCartons: Click Calculate Shipping Estimate button', function () {
        ...
        .then(() => {
            group('SendProductToAmazon_AvailableCartons: Check Slow Boat (UPS delivery) checkbox and click Confirm Shipping Plan button', function () {
        ...
        .then(() => {
            group('SendProductToAmazon_AvailableCartons: Wait for All Done modal and click Go To Dashboard button', function () {
        ...
        .then(() => {
            group('SendProductToAmazon_AvailableCartons: Wait for Dashboard page', function () {
